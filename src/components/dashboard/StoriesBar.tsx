...
const stories = [
  { name: "Sophie M.", avatar: "https://i.pravatar.cc/150?img=5", image: "https://images.unsplash.com/photo-1506744038136-46273834b3fb?w=200&h=300&fit=crop", hasNew: true },
  { name: "Lucas D.", avatar: "https://i.pravatar.cc/150?img=8", image: "https://images.unsplash.com/photo-1498050108023-c5249f4df085?w=200&h=300&fit=crop", hasNew: true },
  { name: "Amina K.", avatar: "https://i.pravatar.cc/150?img=1", image: "https://images.unsplash.com/photo-1519681393784-d120267933ba?w=200&h=300&fit=crop", hasNew: true },
  { name: "Paul R.", avatar: "https://i.pravatar.cc/150?img=4", image: "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=200&h=300&fit=crop", hasNew: false },
  { name: "Claire M.", avatar: "https://i.pravatar.cc/150?img=10", image: "https://images.unsplash.com/photo-1475924156734-496f6cac6ec1?w=200&h=300&fit=crop", hasNew: true },
  { name: "Omar B.", avatar: "https://i.pravatar.cc/150?img=11", image: "https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?w=200&h=300&fit=crop", hasNew: false },
];
